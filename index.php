...
<body>
    <div class="container  ">
        ...
        <div class="card shadow bg-body-tertiary rounded mb-4 ">
            <div class="card-body">
                <form class="d-flex" action="proses.php" method="post">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex ">
                    <a href="update.php?edit=<?php echo $result['id_note']?>" class="btn btn-success btn-sm me-1">
                    ...
                    <a href="delete.php?delete=<?php echo $result['id_note']?>" class="btn btn-danger btn-sm ms-1">
