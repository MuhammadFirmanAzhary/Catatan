...
<body>
    <div class="container  ">
        ...
        <div class="card shadow bg-body-tertiary rounded mb-4 ">
            <div class="card-body">
                <form class="d-flex" action="update.datadata.php" method="post">
                    <input class="form-control me-2" name="title_note" placeholder="TITLE..." required value="<?php echo $result['title_note'] ?>">
                    <input class="form-control me-2" name="note_note" placeholder="KLIK......." required value="<?php echo $result['note_note'] ?>">
